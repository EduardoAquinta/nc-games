export default function Home() {
    return (
        <div>
            ...
            <p>With a large selection of games to hand, we decided it would be a great idea to help others curate their collection with this heady mix of party, euro, and dexterity games.</p>
        </div>
    )
}